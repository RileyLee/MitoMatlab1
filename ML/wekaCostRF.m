function classifier = wekaCostRF(featTrain, classTrain, featName, costMatrix, Parameters)
...
%defining parameters
trainModel.setMaxDepth(Parameters(1)); %Set the maximum depth of the tree, 0 for unlimited.
trainModel.setNumFeatures(Parameters(2)); %Set the number of features to use in random selection.
trainModel.setNumTrees(Parameters(3)); %Set the value of numTrees.
trainModel.setSeed(Parameters(4));
