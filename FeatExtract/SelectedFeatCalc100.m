function [ SelectedFeat ] = SelectedFeatCalc100( IM )
...
%     Spher(i) = ;
    ...
    stats = grayrlpropsOri(GLRLM,'HGRE','LGRE');
    HGRE_BR(i) = mean(stats);
    stats = grayrlpropsSimple(GLRLM,'LGRE');
    LGRE_BR(i) = mean(stats);
%     HGRE_BR(i) = mean(stats(:,7));
    ...
    Median_R(i) = Median(i,1);
    Median_G(i) = Median(i,2);
    Median_B(i) = Median(i,3);    
    Median_H(i) = Median(i,4);
    Median_Llab(i) = Median(i,5);
    Median_Llux(i) = Median(i,6);
    Median_BR(i) = Median(i,7);
    
    Variance_R(i) = Median(i,1);
    Variance_G(i) = Median(i,2);
    Variance_B(i) = Median(i,3);
    Variance_H(i) = Median(i,4);
    Variance_Llab(i) = Median(i,5);
    Variance_Llux(i) = Median(i,6);
    Variance_BR(i) = Median(i,7);
