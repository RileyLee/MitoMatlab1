...
def DNN10_Feats(ImageList,DNN10model, deploy_file, mean_file, labels_file=None, use_gpu=True):
    
    # Load the model and images
    net = get_net(DNN10model, deploy_file, use_gpu)
    transformer = get_transformer(deploy_file, mean_file)
    ...
    out = classify_F(DNN10model, deploy_file, ImageList, mean_file, labels_file=None, use_gpu=False)
